    ...
    <div class="drawer">
      ...
      <div class="drawer-content">
        ...
        <div class="w-full flex justify-center items-center">
          ...
          <div class="form-control">
            <label class="label cursor-pointer ">
              <span class="label-text">Fill Chart</span>
              <input @change=" toggleFill($event)" type="checkbox" class="toggle toggle-primary" />
            </label>
          </div>
        </div>
        <button
        ...
        <div class="w-full flex justify-center">
          <div class="p-4 chart-container w-11/12">
            <canvas ref="myChart" class="mb-20"></canvas>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    this.chart.data.datasets[0].fill = value.target.checked;
    this.updateChart();
